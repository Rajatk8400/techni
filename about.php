		...
		<main>
			...
			<section class="theme__main__banner about__banner position-relative mt-140 mt-md-90">
				<div class="about__banner__bg">
					<img src="assets/img/about/about-1.png" alt="" class="">
			...
			<div class="row align-items-center">
				...
				<div class="col-xxl-3 col-xl-6 col-lg-6">
					<div class="single__offer__box shadow">
						<div class="icon">
							<img class="icon-front" src="assets/img/icon/customer__01.svg" alt="Customer Support">
						</div>
						<div class="offer__name mt-20">
							<h4 class="offer__title mb-10">24/7 Customer Support</h4>
							<p>We provide dedicated support for website, SEO, and digital marketing services anytime.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-xxl-3 col-xl-6 col-lg-6">
					<div class="single__offer__box shadow">
						<div class="icon icon-two">
							<img class="icon-front" src="assets/img/icon/customer__02.svg" alt="Expert Team">
						</div>
						<div class="offer__name mt-20">
							<h4 class="offer__title mb-10">Experienced IT Experts</h4>
							<p>Our team specializes in website development, SEO, Google Ads, and app development.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-xxl-3 col-xl-6 col-lg-6">
					<div class="single__offer__box shadow">
						<div class="icon icon-three">
							<img class="icon-front" src="assets/img/icon/customer__03.svg" alt="Trusted Services">
						</div>
						<div class="offer__name mt-20">
							<h4 class="offer__title mb-10">100% Trusted Services</h4>
							<p>We deliver reliable and result-driven IT solutions trusted by businesses.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-xxl-3 col-xl-6 col-lg-6">
					<div class="single__offer__box shadow">
						<div class="icon icon-four">
							<img class="icon-front" src="assets/img/icon/shield__01.png" alt="Secure Solutions">
						</div>
						<div class="offer__name mt-20">
							<h4 class="offer__title mb-10">Secure & Scalable Solutions</h4>
							<p>We build secure websites and scalable digital solutions for long-term business growth.</p>
						</div>
					</div>
				</div>
		...
		<div class="row d-flex align-items-center">
			...
			<div class="offset-xl-1 col-xl-5 mb-lg-60">
				<div class="choose__img__wrapper position-relative mb-30">
					<img class="choose__main__1" src="assets/img/chose/choose__01.png" alt="IT Services Company">
				</div>
			</div>
						...
						<div class="col-xxl-9">
							...
							<div class="choose__content__wrapper mb-80">
								...
								<h2 class="section__title__main mb-35">
									Best IT Company for Website Development & Digital Marketing
								</h2>

								<p class="mb-30">
									We provide complete IT solutions including website development, SEO services, 
									digital marketing, Google Ads, and graphic design to help your business grow online.
								</p>
								...
								<ul>
									<li>
										<div class="choose__type mb-25 d-flex align-items-center">
											<div class="icon">
												<img src="assets/img/icon/choose__01.svg" alt="Website Development">
											</div>
									...
									<li>
										<div class="choose__type mb-25 d-flex align-items-center">
											<div class="icon icon__two">
												<img src="assets/img/icon/choose__02.svg" alt="SEO Services">
											</div>
											<div class="choose__type__text">
									...
									<li>
										<div class="choose__type mb-25 d-flex align-items-center">
											<div class="icon icon_three">
												<img src="assets/img/icon/choose__03.svg" alt="Digital Marketing">
											</div>
											<div class="choose__type__text">
									...
									<li>
										<div class="choose__type mb-25 d-flex align-items-center">
											<div class="icon icon_four">
												<img src="assets/img/icon/choose__04.svg" alt="Google Ads">
											</div>
											<div class="choose__type__text">
				...
				<div class="row">
					<div class="col-xxl-6 m-auto">
						<h2 class="section__title__main">
							Our Proven Process for Website Development, SEO & Digital Growth
						</h2>
					</div>
				</div>
			...
			<div class="col-xxl-4">
				<div class="about__content__wrapper pb-lg-30">
					<div class="about__type d-flex align-items-center">
						...
						<div class="icon">
							<img src="assets/img/icon/about__two__icon__01.png" alt="Research & Planning">
						</div>

						<div class="about__type_text">
							<h5>01. Research & Strategy</h5>
							<p>
								We analyze your business, competitors, and target audience to create a powerful strategy 
								for website development and digital marketing success.
							</p>
						</div>
				...
				<div class="about__content__wrapper pb-lg-30">
					<div class="about__type d-flex align-items-center">
						...
						<div class="about__type_text">
							...
							<p>
								We create modern, responsive, and SEO-friendly websites along with powerful applications 
								that deliver high performance and user experience.
							</p>
						</div>
			...
			<div class="col-xxl-4">
				<div class="about__content__wrapper pb-lg-30">
					<div class="about__type d-flex align-items-center">
						...
						<div class="icon">
							<img src="assets/img/icon/about__two__icon__03.png" alt="Launch & Marketing">
						</div>

						<div class="about__type_text">
							<h5>03. Launch & Growth Marketing</h5>
							<p>
								After launch, we implement SEO, Google Ads, and Meta Ads strategies to drive traffic, 
				...
				<div class="row px-0 pb-80 pb-md-40">
					...
					<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 me-auto">
						<div class="footer__widget mb-30">
							...
							<h3>
								Get Free IT Tips & Digital Marketing Updates!
							</h3>

							<p>
								Subscribe to get updates on website development, SEO services, 
								Google Ads, and business growth strategies.
							</p>
					...
					<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 ms-auto">
						<div class="footer__widget footer__contact mt-20">
							...
							<p>
								Looking for the best IT company? Contact us for website development, 
							...
							<ul>
								...
								<li><a href="#">Kanpur, Uttar Pradesh, India</a></li>
							</ul>
					...
					<div class="col-lg-6 mb-md-40">
						<div class="text-start">
							<div class="copyright__text">
								<p>
									© 2025 Your Company Name | Website Development & SEO Company in India
								</p>
							</div>
						</div>
					</div>
