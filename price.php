...
<body>
	...
	<div class="main-page-wrapper">
		...
		<main>
				...
				<div class="about__banner__bg">
					...
					<div class="container position-relative">
						<div class="about__content">
							<h2>Pricing Plan</h2>
							<p><a href="index.php">Home</a> - Pages - Pricing Plan</p>
						</div>
					</div>
				</div>
			</section>
						...
						<div class="row align-items-center mt-50">
							...
							<div class="col-xxl-3 col-xl-6 col-lg-6">
								<div class="single__offer__box shadow">
									...
									<div class="offer__name mt-20">
										<h4 class="offer__title mb-10"><a href="services.php">Expert Team</a></h4>
									    <p>There are many variations of pass of Lorem Ipsum available.</p>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-xl-6 col-lg-6">
								<div class="single__offer__box shadow">
									...
									<div class="offer__name mt-20">
										<h4 class="offer__title mb-10"><a href="services.php">100% Trusted</a></h4>
									    <p>There are many variations of pass of Lorem Ipsum available.</p>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-xl-6 col-lg-6">
								<div class="single__offer__box shadow">
									...
									<div class="offer__name mt-20">
										<h4 class="offer__title mb-10"><a href="services.php">Secure Info</a></h4>
									    <p>There are many variations of pass of Lorem Ipsum available.</p>
									</div>
								</div>
							</div>
			...
			<section class="pricing__section__three">
				<div class="container pt-100 pt-lg-60 pb-100 pb-lg-60 mb-130 mb-lg-60">
					<div class="section__title">
						<div class=" text-start text-lg-center">
							<h5 class="sub__title__two mb-20">Pricing List</h5>
						    <h2 class="section__title__main">Great discount & pricing for you.</h2>
						</div>
					</div>
					<div class="row mt-50 d-flex align-items-center">
						<div class="col-xl-4 col-lg-6 pb-lg-30">
							<div class="pricing__table__one text-center">
								<h4 class="pricing__plan mb-40">Basic</h4>
								<p class="price__membership mb-40">Monthly Membership</p>
								<h3 class="monthly__price mb-40">$15.99</h3>
								<hr class="solid">
								<div class="service__list text-center">
									<ul>
										<li>Two Site Creation Only</li>
										<li>50GB Storage Capacity</li>
										<li>550GB Bandwidth Per Month</li>
									</ul>
								</div>
								<div class="service__off__list text-center">
									<ul>
						...
						<div class="col-xl-4 col-lg-6 pb-lg-30">
							<div class="pricing__table__one pricing__table__two text-center">
								<h4 class="pricing__plan mb-40">Standard</h4>
								<p class="price__membership mb-40">Monthly Membership</p>
								<h3 class="monthly__price mb-40">$25.99</h3>
								<hr class="solid">
								<div class="service__list text-center">
									<ul>
										<li>Two Site Creation Only</li>
						...
						<div class="col-xl-4 col-lg-6">
							<div class="pricing__table__one pricing__table__three text-center">
								<h4 class="pricing__plan mb-40">Advance</h4>
								<p class="price__membership mb-40">Monthly Membership</p>
								<h3 class="monthly__price mb-40">$55.99</h3>
								<hr class="solid">
								<div class="service__list text-center">
									<ul>
										<li>Two Site Creation Only</li>
