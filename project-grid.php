...
<body>
	...
	<div class="main-page-wrapper">
		...
		<main>
				...
				<div class="about__banner__bg">
					...
					<div class="container position-relative">
						<div class="about__content">
							<h2>Portfolio</h2>
							<p><a href="index.php">Home</a> - Pages - Portfolio</p>
						</div>
					</div>
				</div>
			</section>
			...
			<!-- portfolio__sectionn start -->
			<section class="portfolio__section__two portfolio__section__three pt-60 pt-lg-60 pb-180 pb-lg-60">
				<div class="container">
						...
						<div class="col-xl-4 col-lg-6">
							<div class="portfolio__wrapper mb-30">
								<div class="portfolio__thumb__right position-relative mb-20">
									...
									<img class="w-100 d-inline-block" src="assets/img/portfolio/portfolio__two__05.png" alt="team">
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-6">
							<div class="portfolio__wrapper mb-30">
								<div class="portfolio__thumb__right position-relative mb-20">
									...
									<img class="w-100 d-inline-block" src="assets/img/portfolio/portfolio__two__06.png" alt="team">
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-6">
