...
<body>
	...
	<div class="main-page-wrapper">
		...
		<main>
			...
			<section class="theme__main__banner about__banner position-relative mt-130 mt-md-90">
				<div class="about__banner__bg">
					<img src="assets/img/about/about__banner__01.png" alt="" class="">
					<div class="container position-relative">
						<div class="about__content">
							<h2>404 Error</h2>
							<p><a href="index.php">Home</a> - Pages - Error</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="not__found__section position-relative mt-130 mt-md-90 mb-130 mb-md-90">
				<div class="about__banner__bg text-center">
					<div class="container">
                        <img src="assets/img/hero/error__01.png" alt="" class="">
						<div class="about__content mt-40">
							<h2 class="">404 Error</h2>
							<p class="mt-20 mb-40">Opps! This Page is Not Found.</p>
                            <div class="custom__btn">
